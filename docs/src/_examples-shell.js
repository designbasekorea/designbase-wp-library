...
(function () {
    ...
    function mountShell() {
        ...
        darkModeToggle.className = 'ex-dark-mode-toggle';
        ...
        // 다크모드 상태 초기화
        var isDarkMode = localStorage.getItem('dewp-dark-mode') === 'true';
        if (isDarkMode) {
            document.documentElement.setAttribute('data-theme', 'dark');
            darkModeToggle.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>';
        }
        ...
        darkModeToggle.addEventListener('click', function () {
            ...
            localStorage.setItem('dewp-dark-mode', newTheme === 'dark');
